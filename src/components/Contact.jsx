      ...
      <div className="container">
        <div className="contact__grid">
          <motion.div className="contact__info" initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.7 }}>
            <motion.p className="section-label" variants={hv} initial="hidden" animate={inView ? 'visible' : 'hidden'} transition={{ duration: 0.6 }}>Get in Touch</motion.p>
            <motion.h2 className="section-title" variants={hv} initial="hidden" animate={inView ? 'visible' : 'hidden'} transition={{ duration: 0.6, delay: 0.1 }}>Let's Connect</motion.h2>
            <p className="contact__desc">
              Have a project idea, want to collaborate, or just want to say hi?
              I'd love to hear from you! Drop me a message or find me on socials. ✨
            </p>
            <div className="contact__socials">
              {socials.map((s, i) => (
                <motion.a key={s.name} href={s.href} className="contact__social glass-card"
                  ...
                  whileHover={{ x: 8, scale: 1.02 }} target="_blank" rel="noopener noreferrer">
          ...
          <motion.div className="contact__form-wrapper" initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.7, delay: 0.2 }}>
            <div className="contact__form-card glass-card">
              ...
              <form onSubmit={handleSubmit} className="contact__form">
                ...
                <motion.button type="submit" className="btn-gradient contact__submit" whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
